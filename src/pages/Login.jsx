    ...
    <div className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm">Sign in to access your saved resumes.</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); window.location.href='/dashboard'; }}>
          ...
          <button type="button" className="w-full btn outline flex items-center justify-center gap-2" onClick={() => window.location.href='/dashboard'}>
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          Not registered yet? <a href="#" className="font-semibold text-blue-600 hover:text-blue-500">Create an account</a>
        </p>
      </motion.div>
    </div>
  );
